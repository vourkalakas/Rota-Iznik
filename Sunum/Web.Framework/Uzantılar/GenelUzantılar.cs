...
{
    public static class GenelUzantılar
    {
        ...
        public static bool SeçimMümkünDeğil(this IList<SelectListItem> items, bool ignoreZeroValue = true)
        {
            if (items == null)
            ...
            bool convertToUserTime, string defaultFormat)
        {
            ...
            else
            {
                ...
                {
                    tmp1 = EngineContext.Current.Resolve<ITarihYardımcısı>().KullanıcıZamanınaDönüştür(tmp1, DateTimeKind.Utc);
                }
                //default formatting
