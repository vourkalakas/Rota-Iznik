...
namespace Eklentiler.Widgets.NivoSlider.Models
{
    public class ConfigurationModel : TemelModel
    {
        public int ActiveStoreScopeConfiguration { get; set; }

        [RotaDisplayNameAttribute("Plugins.Widgets.NivoSlider.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [RotaDisplayNameAttribute("Plugins.Widgets.NivoSlider.Text")]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [RotaDisplayNameAttribute("Plugins.Widgets.NivoSlider.Link")]
